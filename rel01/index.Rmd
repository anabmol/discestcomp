...
## Diferenças entre o R e a IDE RStudio
 ...
 - **Interface** 
   ...
   ![Interface do R](interfacedor.jpg){width="80%"}
  
   ![Interface do RStudio](interfacedorstudio.jpg){width="80%"}
...
## Importando dados
  ...
  - **Ideias básicas**:
    ...
    - No RStudio tem alguns recursos que podem facilitar a importação de dados.
      ...
      - **Passo 1**:
      ![](passo1importandodados.jpg)
      
      - **Passo 2**: Escolher o arquivo para leitura de dados.
      ![](passo2importandodados.jpg)
      ...
      ![](passo4importandodados.jpg){width="80%"}
