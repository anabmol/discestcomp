...
### Via Git 
  ...
  - No 3º quadrante, clicando em *Git*, aparecerá o seguinte visual que irá indicar uma alteração feita em seu relatório.
...
### Via Terminal 
  ...
  - Para que as alterações sejam enviadas de maneira mais rápida e eficiente, esta poderá ser feita através do terminal, localizado no 2º quadrante e deverá seguir os seguintes passos:
...
## Repositório sendo disponibilizado via online
  ...
  - Para isso, o arquivo rmd deverá ser compilado em HTML, clicando em *Knit to HTML* 
